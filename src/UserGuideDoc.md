> 【更新 📢】开源版生命周期服务已结束，覆盖率 75%。已归档为 v1.2.3。红包转账卡组仍可用更新。[赞助](https://weidian.com/item.html?itemID=7385357613&spider_token=b6d5)线上版持续适配。
...
> 更新<br>
`微信助手3.8-1`已修复该问题，更新微信助手插件到最新版本即可。
...
<img src="https://i.imgur.com/m1IN2N5.jpeg" alt="聊天页右上角快捷搜索说明图" width="400" height="auto">
<br>

前往`微信助手`-`其他设置`-`添加搜索按钮`即可。

- 通过其他插件开启的类似功能，可能会导致`图标尺寸过大`和`未适配`问题。请使用`微信助手`开启。

<br><br>

## 7.13. 如何关闭全局分割线？

- 前往`Themebox`-`主题选项`-`全局分割线透明`开启。

...
- 如要贡献参考:[已知问题收集（可参与贡献）](#8-已知问题收集可参与贡献)
...
> 更新：
>
> - `Themebox` 1.0.9 版本已经更新，`主题选项` 单独增加了 `气泡裁剪` 配置项。开启气泡裁剪设置 `18*18*18*18` 即可。（改配置只针对**本主题设计的气泡**，如你使用其他主题气泡替换本主题气泡，气泡设置的属性值请参考其他作者声明）
